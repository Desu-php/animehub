...
__webpack_require__(/*! ./global/alert-message */ "./resources/js/global/alert-message.js");

__webpack_require__(/*! ./global/notification */ "./resources/js/global/notification.js");

__webpack_require__(/*! ./global/menu */ "./resources/js/global/menu.js");

__webpack_require__(/*! ./global/sign_in */ "./resources/js/global/sign_in.js");

__webpack_require__(/*! ./global/short-text.js */ "./resources/js/global/short-text.js");
...
/***/ "./resources/js/global/alert-message.js":
/*!**********************************************!*\
  !*** ./resources/js/global/alert-message.js ***!
  \**********************************************/
/***/ (() => {

var messagePlace = document.querySelector('.message-place');
var closeMessage;
var allMes = new Array();
var crossLength = new Array();
var BODY = $('body');
var error = 'error-message';
var successful = 'successful-message';
var BASE_API = BODY.data('api');
var BASE_URL = BODY.data('url');

function showMessage(name, discription, typeMessage) {
  createMessage(name, discription, typeMessage);
  var alertMessageBlock = document.querySelectorAll('.alert-message-block');
  closeMessage = document.querySelectorAll('.alert-cross');
  closeMessage.forEach(function (elem, index) {
    elem.onclick = function () {
      alertMessageBlock[index].classList.remove('show-alert');
      allMes = [];
      setTimeout(function () {
        return elem.parentNode.remove();
      }, 500);
    };
  });
}
...
function createMessage(name, discription, typeMessage) {
  ...
  mes.innerHTML = "\n    <div class=\"alert-message-top\"><div class=\"message-name\">".concat(name, "</div></div>\n    <div class=\"alert-cross\">\n      <div class=\"alert-cross-line\"></div>\n      <div class=\"alert-cross-line\"></div>\n    </div>\n    <div class=\"alert-message-body\">").concat(discription, "</div>\n  ");
  setTimeout(function () {
  ...
  allMes.push(mes);
  var qwer = document.querySelectorAll('.alert-message-block');

  if (allMes.length > 1) {
    allMes.shift();
    qwer[qwer.length - 1].classList.remove('show-alert');
    setTimeout(function () {
      return qwer[qwer.length - 1].remove();
    }, 500);
  }
...
innerChat.onscroll = function () {
  var scrollBottom = innerChat.scrollHeight - innerChat.scrollTop - innerChat.clientHeight;
...
crossChat.onclick = function () {
  ...
  chat.style.left = 0;
  setTimeout(function () {
    chat.style.transform = "translateX(-".concat(chat.clientWidth + 15, "px)");
...
chatHeader.onmousedown = function (event) {
  ...
  var shiftX = event.clientX - chat.getBoundingClientRect().left;
  var shiftY = event.clientY - chat.getBoundingClientRect().top;
...
function viewAvatar(str) {
  if (isLaravel(str)) {
    return "".concat(BASE_URL, "/").concat(str);
  }
...
function template(avatar, username, date, mess, color, font, id_chat, status, status_color) {
  ...
  var message = "<div class=\"chat-item\">\n        <div class=\"chat-user\" id=\"".concat(id_chat, "\">\n          <div class=\"chat-user-avatar\"><img src=\"").concat(viewAvatar(avatar), "\"></div>\n          <div class=\"chat-user-right\">\n            <div class=\"chat-user-name\"><a style=\"").concat(color, ";font-family:'").concat(font, "'\" href=\"/profile/").concat(username, "\">").concat(username, "</a> <span style=\"color: ").concat(status_color, "\">").concat(status, "</span></div>\n            <div class=\"chat-date\">").concat(date, "</div>\n          </div>\n        </div>\n\n        <div class=\"chat-text\">").concat(mess, "</div>\n      </div>");
  $("#chat").append(message);
...
function ajaxView(avatar, username, date, mess, color, font, id_chat, status, status_color) {
  // var message=`<div class="chat-item" style="display:none">
  var message = "<div class=\"chat-item\">\n        <div class=\"chat-user\" id=\"".concat(id_chat, "\">\n          <div class=\"chat-user-avatar\"><img src=\"").concat(avatar, "\"></div>\n          <div class=\"chat-user-right\">\n            <div class=\"chat-user-name\"><a style=\"").concat(color, ";font-family:'").concat(font, "'\" href=\"/profile/").concat(username, "\">").concat(username, "</a> <span style=\"color: ").concat(status_color, "\">").concat(status, "</span></div>\n            <div class=\"chat-date\">").concat(date, "</div>\n          </div>\n        </div>\n\n        <div class=\"chat-text\">").concat(mess, "</div>\n      </div>");
...
function openSubMenu() {
  ...
  setTimeout(function () {
    return document.body.classList.add('opacity-sub-menu');
  }, 10);
}
...
function closeSubMenu() {
  ...
  setTimeout(function () {
    return document.body.classList.remove('open-sub-menu');
  }, 500);
}
...
function openMenu() {
  ...
  setTimeout(function () {
    return document.body.classList.add('background-opacity');
  }, 0);
}
...
function closeMenu() {
  ...
  setTimeout(function () {
    return backgroundMenu.style.display = 'none';
  }, 500);
}
...
/***/ "./resources/js/global/notification.js":
/*!*********************************************!*\
  !*** ./resources/js/global/notification.js ***!
  \*********************************************/
/***/ (() => {
...
var deleteAllNotification = document.querySelector('.bottom-notification');
var notificationLength = document.querySelector('.notification-length');
var closeNotification = document.querySelector('.notification-cross');
var notificationItem = document.querySelectorAll('.notification-item');
var newNotification = document.querySelectorAll('.new-notification');
var showNotification = document.querySelectorAll('.notification-text');
var trash = document.querySelectorAll('.fa-trash');
var token = document.getElementById('token');
var notificationDescription = document.querySelectorAll('.notification-description');
var prevNot,
    presNot = 0;

if (notification !== null) {
  var viewNotification = function viewNotification(elem, index) {
    prevNot = presNot;
    presNot = index;
    notificationItem[index].classList.remove('new-notification');
    newNotification = document.querySelectorAll('.new-notification');
    notificationLength.innerHTML = "(".concat(newNotification.length, ")");
    ...
    if (notificationItem[prevNot].classList.contains('open-notifications-item')) {
      notificationItem[prevNot].style.height = "".concat(notificationItem[prevNot].scrollHeight - 20, "px");
    ...
    if (notificationItem[index].classList.contains('open-notifications-item')) {
      notificationItem[index].style.height = "".concat(notificationItem[index].scrollHeight - 20, "px");
  ...
  var updateNotification = function updateNotification(elem, index) {
  ...
  notification.onmouseenter = function () {
    return notification.style.right = "calc(100% - ".concat(notification.clientWidth, "px)");
  };

  notification.onmouseleave = function () {
    return notification.style.right = "calc(100% - 35px)";
  };

  notification.onclick = function () {
    document.body.classList.add('open-notification');
    setTimeout(function () {
      return document.body.classList.add('open-notification-opacity');
    }, 0);
  };

  closeNotification.onclick = function () {
    for (var i = 0; i < notificationItem.length; i++) {
      notificationItem[i].style.height = "35px";
    }

    ;
    document.body.classList.remove('open-notification-opacity');
    setTimeout(function () {
      return document.body.classList.remove('open-notification');
    }, 500);
  };

  showNotification.forEach(function (elem, index) {
    elem.onclick = function () {
      updateNotification(elem, index);
      setTimeout(function () {
        return viewNotification(elem, index);
      }, 10);
    };
  });
  ;
  trash.forEach(function (elem, index) {
    elem.onclick = function () {
      $.ajax({
        type: "post",
  ...
  deleteAllNotification.onclick = function () {
    $.ajax({
      type: "post",
      url: "/ajax/notification/delete",
      data: {
      ...
      dataType: "text",
      success: function success(response) {
        notificationItem.forEach(function (elem) {
          elem.remove();
        });
...
/***/ "./resources/js/global/questionnaire.js":
/*!**********************************************!*\
  !*** ./resources/js/global/questionnaire.js ***!
  \**********************************************/
/***/ (() => {

var questionnairePanelItem = document.querySelectorAll('.questionnaire-panel-item');
var questionnaireLength = document.querySelectorAll('.questionnaire-length');
var questionnairePanelItemShadow = document.querySelectorAll('.questionnaire-panel-item-shadow');
var questionnairePanel = document.querySelector('.questionnaire-panel');
var questionnaireGeneralChoose = document.querySelector('.questionnaire-general-choose');
var sumQuestionnaire = 0;
...
function countVote() {
  ...
  ;
  questionnaireGeneralChoose.innerHTML = "\u041F\u0440\u043E\u0433\u043E\u043B\u043E\u0441\u043E\u0432\u0430\u043B\u043E ".concat(sumQuestionnaire, " \u0447\u0435\u043B\u043E\u0432\u0435\u043A");
}

;
questionnairePanelItem.forEach(function (elem, index) {
  elem.onclick = function () {
    ...
    $.ajax({
      ...
      url: "/ajax/add/vote",
      data: {
        "id_answer": questionnairePanelItem[index].querySelector('.questionnaire-item').id,
        "id_quest": $(".question").attr("id"),
        "token": $("#token").text()
      },
      dataType: "text",
      success: function success(response) {
...
var ajaxSearch = document.querySelector('.ajax-search');
...
search.onfocus = function () {
  ...
  ;
  setTimeout(function () {
    return searchForm.classList.add('full-height');
  }, 300);
};
...
$(".search-block .search").on("input", function (e) {
      ...
      success: function success(response) {
        ...
        if (response[0].count != 0) {
          for (var i = 0; i < response.length; i++) {
            ajaxContent += "<div class=\"ajax-block\">\n              <a href=\"".concat(response[i].src, "\">\n                <div class=\"search-name\">").concat(response[i].title, "</div>\n                <div class=\"search-img\"><img src=\"").concat(response[i].img, "\"></div>\n              </a>\n            </div>\n            ");
          }
...
$(".search-block .cross").click(function () {
  $(".ajax-search").css("display", "none");
  $(".search-block .cross").css("display", "none");
});
...
/***/ "./resources/js/global/short-text.js":
/*!*******************************************!*\
  !*** ./resources/js/global/short-text.js ***!
  \*******************************************/
/***/ (() => {

var updateName = document.querySelectorAll('.update-name');
var topWeakFilmName = document.querySelectorAll('.top-weak-film-name');
var commentsNameFilm = document.querySelectorAll('.comments-name-film');
var titleNotification = document.querySelectorAll('.title-notification');
...
/***/ "./resources/js/global/sign_in.js":
/*!****************************************!*\
  !*** ./resources/js/global/sign_in.js ***!
  \****************************************/
/***/ (() => {

var profile = document.querySelector('#profile-button');
var exitProfile = document.querySelector('.exit-profile');
var signIn = document.querySelector('#sign-in-button');
var exitSignIn = document.querySelector('.exit-sign-in');
...
function openProfile() {
  ...
  setTimeout(function () {
    return document.body.classList.add('sign-in-opacity');
  }, 0);
}
...
function closeProfile() {
  ...
  setTimeout(function () {
    return document.body.classList.remove('open-profile');
  }, 500);
}
...
function closeSignIn() {
  document.body.classList.remove('sign-in-opacity');
  setTimeout(function () {
    return document.body.classList.remove('sign-in');
  }, 500);
}

;
var signInInput = document.querySelectorAll('.sign-in-input');
var mainInput = document.querySelectorAll('.sign-in-input-item');
var registInput = document.querySelectorAll('.registration-input');
var mainRegistInput = document.querySelectorAll('.registration-input-item');
mainInput.forEach(function (elem, index) {
  return inputFocus(elem, index, signInInput, 'sign-in-input-focus');
});
mainRegistInput.forEach(function (elem, index) {
  return inputFocus(elem, index, registInput, 'registration-input-focus');
});

function inputFocus(elem, index, inputItem, classFocus) {
  elem.onfocus = function () {
    return inputItem[index].classList.add(classFocus);
  };

  elem.onblur = function () {
    return elem.value == '' ? inputItem[index].classList.remove(classFocus) : elem;
  };
}
...
/******/ 	__webpack_require__.O(undefined, ["css/regist","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/regist","css/app"], () => (__webpack_require__("./resources/css/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/regist","css/app"], () => (__webpack_require__("./resources/css/regist.css")))
